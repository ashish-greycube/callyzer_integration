...
# app_include_js = "/assets/js/callyzer.min.js"
...
after_migrate="callyzer_integration.migrations.after_migrate"
# Desk Notifications
# ------------------
...
fixtures = [
      {
        "dt": "Custom Field", 
        "filters": [["name", "in", ['Sales Person-mobile_no_cf','Lead-call_info_cf','Lead-check_call_log_cf']]]
      }	   			     
]